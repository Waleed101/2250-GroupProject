...
public class Enemy : MonoBehaviour
{
    ...
    private bool _isWalking = true, _fight = false, _dieSequenceStarted = false, _alreadyEnteredPlayerZone = false;
    ...
    public virtual void Start()
    {
        ...
        // Get reference to player and enemy animator
    ...
    public virtual void AffectPlayer()
    {
        ...
        if (((Time.time - timeSinceLast) > timeToNextKill) && anim.GetBool("Fight"))
        {
            ...
            player.GetComponent<HealthManager>().TakeDamage(1f);
    ...
    public virtual void Move()
    {
        ...
        Vector3 pos = Vector3.MoveTowards(transform.position, playerPos, movementSpeed * Time.deltaTime);
